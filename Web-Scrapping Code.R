...
pacman::p_load(tidyverse, rvest, lubridate, xlsx, openxlsx)
...
# Extracting unnecessary elements
...
# MovieData-API -----------------------------------------------------------
Movie = read_csv('https://github.com/Kurtzm23/ISA401-FinalProject/raw/main/MovieData.csv')
...
## Exporting to Excel
# IMDB Data
write.xlsx(imbd_tbl, file = "IMDB_Group_Project_Data.xlsx",
           sheetName = "IMDB Data", overwrite = TRUE)
# Rotten Tomatoes Data
write.xlsx(rotten_tbl, file = "RT_Group_Project_Data.xlsx", 
           sheetName="Rotten Tomatoes Data", overwrite = TRUE)
# Movie API
write.xlsx(Movie, file = "API_Group_Project_Data.xlsx", 
           sheetName="Movie API", overwrite = TRUE)
# Wikipedia Data
write.xlsx(wiki_tbl, file = "Wiki_Group_Project_Data.xlsx", 
           sheetName="Wikipedia Data", overwrite = TRUE)
