...
## Exporting to Excel
# IMDB Data
write.xlsx(imbd_tbl, file = "Group_Project_Data.xlsx",
           sheetName = "IMDB Data", append = FALSE)
# Rotten Tomatoes Data
write.xlsx(rotten_tbl, file = "Group_Project_Data.xlsx", 
           sheetName="Rotten Tomatoes Data", append=TRUE)
# Movie API
write.xlsx(Movie, file = "Group_Project_Data.xlsx", 
           sheetName="Movie API", append=TRUE)
# Wikipedia Data
write.xlsx(wiki_tbl, file = "Group_Project_Data.xlsx", 
           sheetName="Wikipedia", append=TRUE)
